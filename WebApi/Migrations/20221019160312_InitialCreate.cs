        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowingTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    BorrowingLimitTime = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    WasReturned = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UpdatedOn = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
